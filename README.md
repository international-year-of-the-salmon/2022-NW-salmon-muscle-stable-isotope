...
🙋 Welcome to the repository for the stable isotope ratio and elemental contents data for salmon muscle tissue collected from the F/V Northwest Explorer collected in 2022, as part of the International Year of the Salmon High Seas Expedition.

🤖 See the metadata record for this dataset here: https://doi.org/10.21966/j6kt-9p56
